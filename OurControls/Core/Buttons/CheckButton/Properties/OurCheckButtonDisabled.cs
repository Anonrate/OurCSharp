// ----------------------------------------------------------------------------
// <copyright file="OurCheckButtonDisabled.cs" company="OurCSharp">
...
namespace OurCSharp.OurControls.Core.Buttons.CheckButton.Properties
{
    ...
    internal class OurCheckButtonDisabled : IOurCheckButtonDesigner
    {
        #region Fields
        ...
        public Color CheckBorderColor { get; set; } = Color.FromArgb(255, 50, 50, 50);

        [Description("Color of the background where the check is.")]
        public Color CheckBackColor { get; set; } = Color.FromArgb(255, 50, 50, 50);
        ...
        #region Constructors
        public OurCheckButtonDisabled(OurCheckButtonBase checkButtonBase) { this._checkButtonBase = checkButtonBase; }
        #endregion
    }
}