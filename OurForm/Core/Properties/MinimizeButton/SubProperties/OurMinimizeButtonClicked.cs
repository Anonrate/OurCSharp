// ----------------------------------------------------------------------------
// <copyright file="OurMinimizeButtonClicked.cs" company="OurCSharp">
...
namespace OurCSharp.OurForm.Core.Properties.MinimizeButton.SubProperties
{
    ...
    internal class OurMinimizeButtonClicked : IOurFormButtonDesigner
    {
        #region Fields
        ...
        #region Constructors
        public OurMinimizeButtonClicked(OurForm ourForm) { this._ourForm = ourForm; }
        #endregion
