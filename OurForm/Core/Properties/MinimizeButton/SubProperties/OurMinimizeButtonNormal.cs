// ----------------------------------------------------------------------------
// <copyright file="OurMinimizeButtonNormal.cs" company="OurCSharp">
...
namespace OurCSharp.OurForm.Core.Properties.MinimizeButton.SubProperties
{
    ...
    internal class OurMinimizeButtonNormal : IOurFormButtonDesigner
    {
        #region Fields
        ...
        #region Constructors
        public OurMinimizeButtonNormal(OurForm ourForm) { this._ourForm = ourForm; }
        #endregion
