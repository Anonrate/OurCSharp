// ----------------------------------------------------------------------------
// <copyright file="OurMinimizeButtonHovered.cs" company="OurCSharp">
...
namespace OurCSharp.OurForm.Core.Properties.MinimizeButton.SubProperties
{
    ...
    internal class OurMinimizeButtonHovered : IOurFormButtonDesigner
    {
        #region Fields
        ...
        #region Constructors
        public OurMinimizeButtonHovered(OurForm ourForm) { this._ourForm = ourForm; }
        #endregion
