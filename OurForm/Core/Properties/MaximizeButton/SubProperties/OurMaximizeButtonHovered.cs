// ----------------------------------------------------------------------------
// <copyright file="OurMaximizeButtonHovered.cs" company="OurCSharp">
...
namespace OurCSharp.OurForm.Core.Properties.MaximizeButton.SubProperties
{
    ...
    internal class OurMaximizeButtonHovered : IOurFormButtonDesigner
    {
        #region Fields
        ...
        #region Constructors
        public OurMaximizeButtonHovered(OurForm ourForm) { this._ourForm = ourForm; }
        #endregion
