// ----------------------------------------------------------------------------
// <copyright file="OurCloseButtonNormal.cs" company="OurCSharp">
...
namespace OurCSharp.OurForm.Core.Properties.CloseButton.SubProperties
{
    ...
    internal class OurCloseButtonNormal : IOurFormButtonDesigner
    {
        #region Fields
        ...
        #region Constructors
        public OurCloseButtonNormal(OurForm ourForm) { this._ourForm = ourForm; }
        #endregion
